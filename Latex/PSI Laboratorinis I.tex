...
\begin{figure}[H]
		\centering	
	\includegraphics[width=17cm,height=20cm,keepaspectratio]{l2v2uki.png}
	\caption{}
	\label{fig:L1V2}
\end{figure}

\item L2(Ūkininko panelė): Šioje diagramoje rodomas ūkininko komponento bendravimas su sistema. Sistema sukuria interfeina ir paduoda duomenis ūkininko grafinei vartotojo sąsajai. Sistema duomenis gauna iš Event log komponento. Sistema įgyvendima AC kurimą interfeisą.
