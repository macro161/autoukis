...
\end{figure}
Šioje diagramoje matome, kad Admin pateikus užklausą planuojamui pelnui gauti, Admin UI kreipiasi į Calculations klasę su prašymu jį apskaičiuoti. Ši savo ruožtu norėdama gauti reikiamus duomenis kreipiasi į klases UkioTechnika, Map ir Orai.
\end{itemize}
\subsection{Proceso pjūvis}
\subsection{Fizinis pjūvis}
