...
\begin{table}[htbp]
	\begin{tabularx}{1\textwidth}{ |P{2.5cm}|X|P{3cm }| }  \hline
		Nr. & Reikalavimas & Prioritetas(1-10) \\ \hline
		NFR-7.20 & Programuotojui turi būti suteikta prieeiga prie Visual Studio 2017 & 10
		NFR-7.21 & Visual Studio 2017 turi būti įdiegtas Xamarin paketas & 10
		NFR-7.22 & Visual Studio 2017 turi būti įdiegtas Android SDK paketas & 10
		NFR-7.23 & Visual Studio 2017 turi būti įdiegtas Android emuliatorius & 10
		NFR-7.23 & Visual Studio 2017 turi būti įdiegtas iOS SDK & 10
		NFR-7.23 & Visual Studio 2017 turi būti įdiegtas iOS emuliatorius & 10
	\end{tabularx}
\end{table}
...
\begin{table}[htbp]
	\begin{tabularx}{1\textwidth}{ |P{2.5cm}|X|P{3cm }| }  \hline
		Nr. & Reikalavimas & Prioritetas(1-10) \\ \hline
		NFR-7.22 & Sistema gali sutrikti ne dažniau kaip kartą per mėnesį & 10 \\ \hline
	\end{tabularx}
\end{table}
