...
\begin{table}[htbp]
	\begin{tabularx}{1\textwidth}{ |P{2.5cm}|X|P{3cm }| }  \hline
		Nr. & Reikalavimas & Prioritetas(1-10) \\ \hline
		NFR-7.01 & Sistema pritaikyta naudoti bet kurioje iš Microsoft Windows, Linux ir Mac OS operacinių sistemų & 10 \\ \hline
	\end{tabularx}
\end{table}
...
\begin{table}[htbp]
	\begin{tabularx}{1\textwidth}{ |P{2.5cm}|X|P{3cm }| }  \hline
		Nr. & Reikalavimas & Prioritetas(1-10) \\ \hline
		NFR-7.02 & Sistema naudoja duomenų bazę, kurioje saugomi gyvūnų bei žemėlapių duomenys, taip pat ir vartotojų prisijungimo duomenys & 10\\ \hline
		NFR-7.03 & Duomenų mainų interfeisai turi būti SQL ir PL/SQL & 8   \\ \hline
	\end{tabularx}
\end{table}
...
\begin{table}[htbp]
	\begin{tabularx}{1\textwidth}{ |P{2.5cm}|X|P{3cm }| }  \hline
		Nr. & Reikalavimas & Prioritetas(1-10) \\ \hline
		NFR-7.09 & Sistema privalo būti įgyvendinta naudojant C\# programavimo kalbą & 10 \\ \hline
	\end{tabularx}
\end{table}
