...
\begin{itemize}
	...
	\item Ligų žemėlapis kaimyninėse teritorijose
...
\begin{table}[htbp]
	\begin{tabularx}{1\textwidth}{ |P{2.5cm}|X|P{3cm }| }  \hline
           	Nr. & Reikalavimas &  Prioritetas (1-10)  \\   \hline 
         	FR-5.01 & Sistema leidžia stebėti šios ir sekančios dienos orų prognozes & 10  \\   \hline
		FR-5.02 & Andromedai įsirėžus į Paukščių Tako galaktiką išvesti klaidos pranešimą & 1 \\  \hline
		FR-5.03 & Nepavykus prisijungti prie serverio, vartotojui leidžiama bandyti dar kartą prisijungus prie interneto & 7 \\ \hline
	\end{tabularx}
\end{table}
...
\subsection{Žolių ir ligų katalogas}
	...
	\begin{table}[htbp]
		\begin{tabularx}{1\textwidth}{ |P{2.5cm}|X|P{3cm }| }  \hline
			...
			FR-24.02.01 & Pagal simbolių eilutę esančią pavadinime & 9 \\ \hline
			FR-24.02.01 & Pagal simbolių eilutę esančią aprašyme & 8 \\ \hline
