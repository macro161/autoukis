...
public class AutoUkis extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        aaaaaaaaaaaaaa = new javax.swing.JComboBox<>();
        jTextField1 = new javax.swing.JTextField();
        jTextField2 = new javax.swing.JTextField();
        jTextField3 = new javax.swing.JTextField();
        jScrollPane3 = new javax.swing.JScrollPane();
        weatherToday = new javax.swing.JTextArea();
        jScrollPane2 = new javax.swing.JScrollPane();
        weatherTomorrow = new javax.swing.JTextArea();
                    ...
                    .addGroup(panelOneLayout.createSequentialGroup()
                        ...
                        .addGroup(panelOneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(panelOneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(buttonThirteen, javax.swing.GroupLayout.DEFAULT_SIZE, 243, Short.MAX_VALUE)
                                .addComponent(buttonFourteen, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(buttonFifteen, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(buttonSixteen, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(buttonSeventeen, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        aaaaaaaaaaaaaa.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        aaaaaaaaaaaaaa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...", "Alytus", "Vilnius", "Kaunas", "Klaipėda", "Panevėžys" }));
        aaaaaaaaaaaaaa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                aaaaaaaaaaaaaaActionPerformed(evt);
            }
        });

        jTextField1.setEditable(false);
        jTextField1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jTextField1.setText("Artimiausias miestas:");
        jTextField1.setBorder(null);

        jTextField2.setEditable(false);
        jTextField2.setText("Šiandienos orai:");
        jTextField2.setBorder(null);

        jTextField3.setEditable(false);
        jTextField3.setText("Rytojaus orai:");
        jTextField3.setBorder(null);

        weatherToday.setEditable(false);
        weatherToday.setColumns(20);
        weatherToday.setRows(5);
        jScrollPane3.setViewportView(weatherToday);
        weatherToday.getAccessibleContext().setAccessibleName("weatherToday");

        weatherTomorrow.setEditable(false);
        weatherTomorrow.setColumns(20);
        weatherTomorrow.setRows(5);
        jScrollPane2.setViewportView(weatherTomorrow);
        weatherTomorrow.getAccessibleContext().setAccessibleName("weatherTomorrow");
                ...
                .addGroup(panelFiveLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelFiveLayout.createSequentialGroup()
                        ...
                        .addGroup(panelFiveLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(aaaaaaaaaaaaaa, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(119, 119, 119))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelFiveLayout.createSequentialGroup()
    ...
    private void aaaaaaaaaaaaaaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aaaaaaaaaaaaaaActionPerformed
        String miestas;
        int city;
        miestas = (String)aaaaaaaaaaaaaa.getSelectedItem();
        switch(miestas)
        {
            case "Alytus":
            {
        ...
        weather(city);
    }//GEN-LAST:event_aaaaaaaaaaaaaaActionPerformed

    public int weather(int city)
    {
        if(city == 0)
        {
            weatherToday.setText("Nepasirinktas miestas");
            weatherTomorrow.setText("Nepasirinktas miestas");
            return 0;
        }
        ...
        weatherToday.setText(miestas + "\nTemperatūra: " + temp + "\nSlėgis: " + slegis + "\nVėjo greitis: " + vejas);
        
        temp = document.select("#weather-daily .value.m_temp.c").text();
        temp = temp.substring(5, 8) + "°C";
        slegis = document.select("#weather-daily .value.m_press.torr").text();
        slegis = slegis.substring(0, 3) + "mm Hg";
        vejas = document.select("#weather-daily .value.m_wind.ms").text();
        vejas = vejas.substring(0, 2) + "m/s";
        weatherTomorrow.setText(miestas + "\nTemperatūra: " + temp + "\nSlėgis: " + slegis + "\nVėjo greitis: " + vejas);
    ...
    private javax.swing.JComboBox<String> aaaaaaaaaaaaaa;
    ...
    private javax.swing.JTextArea weatherToday;
    private javax.swing.JTextArea weatherTomorrow;
